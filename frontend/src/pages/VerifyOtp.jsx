                        ...
                        >
                            {digits.map((digit, index) => (
                                <input
                                    ...
                                    className={`w-11 h-14 sm:w-12 sm:h-16 text-center font-mono text-3xl tracking-widest rounded-2xl bg-slate-800/80 border text-white outline-none transition-all duration-300 focus:ring-2 focus:ring-emerald-400/70 focus:border-transparent focus:bg-slate-800 focus:shadow-[0_0_20px_rgba(16,185,129,0.35)] ${digit
